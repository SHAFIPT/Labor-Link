...
// import {authenticateUser, decodedUserRefreshToken, verifyRefreshUserTokenMiddleware } from "../../middleware/authMiddleware";
...
// userAuthRoute.get('/refresh-token', verifyRefreshUserTokenMiddleware, authController.refreshAccessToken.bind(authController));

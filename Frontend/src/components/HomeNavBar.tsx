    ...
    >
      <label className="toggle" htmlFor="switch" onClick={toggleDarkMode}>
        ...
        {theme === "dark" ? (
          ...
          <div className=" lg:hidden md:hidden sm:hidden items-center ">
          ...
          {theme === "dark" ? (
            ...
            <div className="flex flex-col items-center justify-center p-1 sm:p-2 transition-all hover:scale-105">
              <div className="relative flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 lg:w-20 lg:h-20">
                ...
                width="356.000000pt" height="351.000000pt" viewBox="0 0 356.000000 351.000000"
                preserveAspectRatio="xMidYMid meet"
                className="w-7 h-7 sm:w-8 sm:h-8 lg:w-12 lg:h-12"
                  >

                <g transform="translate(0.000000,351.000000) scale(0.100000,-0.100000)"
                fill="#57e5d0" stroke="none">
            ...
            <div className="flex flex-col items-center justify-center p-1 sm:p-2 transition-all hover:scale-105">
              <div className="relative flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 lg:w-20 lg:h-20">
                <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                  width="500.000000pt" height="499.000000pt" viewBox="0 0 500.000000 499.000000"
           ...
           <div className="flex flex-col items-center justify-center p-1 sm:p-2 transition-all hover:scale-105">
              <div className="relative flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 lg:w-20 lg:h-20">
                <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                width="551.000000pt" height="453.000000pt" viewBox="0 0 551.000000 453.000000"
                preserveAspectRatio="xMidYMid meet"
                className="w-7 h-7 sm:w-8 sm:h-8 lg:w-12 lg:h-12"
                >
            ...
            <div className="flex flex-col items-center justify-center p-1 sm:p-2 transition-all hover:scale-105">
              <div className="relative flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 lg:w-20 lg:h-20">
                <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                width="515.000000pt" height="484.000000pt" viewBox="0 0 515.000000 484.000000"
                preserveAspectRatio="xMidYMid meet" className="w-7 h-7 sm:w-8 sm:h-8 lg:w-12 lg:h-12">
            ...
            <div className="flex flex-col items-center justify-center p-1 sm:p-2 transition-all hover:scale-105">
              <div className="relative flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 lg:w-20 lg:h-20">
                <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                width="447.000000pt" height="443.000000pt" viewBox="0 0 447.000000 443.000000"
                preserveAspectRatio="xMidYMid meet" className="w-7 h-7 sm:w-8 sm:h-8 lg:w-12 lg:h-12">
            ...
            <div className="flex flex-col items-center justify-center p-1 sm:p-2 transition-all hover:scale-105">
              <div className="relative flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 lg:w-20 lg:h-20">
                <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                width="486.000000pt" height="397.000000pt" viewBox="0 0 486.000000 397.000000"
                preserveAspectRatio="xMidYMid meet" className="w-7 h-7 sm:w-8 sm:h-8 lg:w-12 lg:h-12">

              ...
              <div className="text-center md:text-left">
                ...
                <div className="flex flex-wrap justify-center md:justify-start gap-2 mt-2">
                  {labor.categories.map((category, index) => (
                    <span key={index} className="px-3 py-1 bg-blue-500 bg-opacity-40 rounded-full text-sm text-white">
                      {category}
                    </span>
                  ))}
                </div>
              ...
              <div className="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition-shadow">
                ...
                <div className="space-y-3">
                  ...
                  <p className="flex justify-between">
                    ...
                    <span className="font-medium">{labor.personalDetails.gender}</span>
                  </p>
                  <p className="flex justify-between">
                    <span className="text-gray-600">Birth Date</span>
                    <span className="font-medium">{new Date(labor.personalDetails.dateOfBirth).toLocaleDateString()}</span>
                  </p>
                  <p className="flex justify-between">
              ...
              <div className="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition-shadow">
                ...
                <div className="space-y-3">
                  ...
                  <p className="flex justify-between">
                    ...
                    <span className="font-medium">{labor.address.postalCode}</span>
                  </p>
                </div>
              </div>
            </div>
                    ...
                    <div className="space-y-3">
                      <p className="flex justify-between">
                        ...
                        <span className="font-medium">
                          {new Date(labor.DurationofEmployment.startDate).toLocaleDateString()}
                        </span>
                      </p>
                      <p className="flex justify-between">
                        <span className="text-gray-600">Current Status</span>
                        <span className="font-medium">
                          {labor.DurationofEmployment.currentlyWorking ? 'Active' : 'Inactive'}
                        </span>
                      </p>
                    </div>
                  </div>

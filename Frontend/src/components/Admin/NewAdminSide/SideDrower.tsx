...
// Define the prop types for SideDrower
interface SideDrawerProps {
  isCollapsed: boolean;
  toggleSidebar: () => void;
}

const SideDrower: React.FC<SideDrawerProps> = ({
  isCollapsed,
  toggleSidebar,
}) => {
  const location = useLocation(); // Get current route
  const [hoveredItem, setHoveredItem] = useState<string | null>(null); // Ensure TypeScript knows it's a string or null
  ...
  const menuItems = [
    ...
    },
    {
      ...
      icon: <Users size={20} />,
      route: "/admin/userManagentPage",
    },
    {
      name: "Laborer Management",
      icon: <Hammer size={20} />,
      route: "/admin/laborManagentPage",
    },
    {
      name: "Booking Management",
      icon: <Calendar size={20} />,
      route: "/admin/bookingsManagementPage",
    },
    {
      name: "Payment and Earnings",
      icon: <CreditCard size={20} />,
      route: "/admin/paymentsManagementPage",
    },
    {
      name: "Withdrawal Pendings",
      icon: <Wallet size={20} />,
      route: "/admin/withdrowalManagementPage",
    },
  ];

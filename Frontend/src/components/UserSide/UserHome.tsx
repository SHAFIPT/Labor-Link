        ...
        <div className="FirstLine flex flex-col md:flex-row items-center justify-start space-y-8 md:space-y-0 md:space-x-[25px] relative">
          ...
          <div className="secondStage text-center md:text-left">
            ...
            {isDarkmode == 'light' ? (
              ...
              width="749.000000pt" height="333.000000pt" viewBox="0 0 749.000000 333.000000"
              preserveAspectRatio="xMidYMid meet" className="w-[150px] sm:w-[200px] md:w-[400px]">
        ...
        <div className="FirstLine flex flex-col md:flex-row items-center justify-start space-y-8 md:space-y-0 md:space-x-2 relative">
          ...
          <div className="fristArrow hidden md:block">
            {isDarkmode === 'light' ? (
              ...
              <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                width="491.000000pt" height="508.000000pt" viewBox="0 0 491.000000 508.000000"
                preserveAspectRatio="xMidYMid meet" className="w-[150px] sm:w-[200px] md:w-[350px]">

                <g transform="translate(0.000000,508.000000) scale(0.100000,-0.100000)"
                fill="#ffffff" stroke="none">
                <path d="M2586 3866 c-39 -47 -43 -56 -23 -56 13 0 77 76 77 92 0 19 -21 5
                -54 -36z"/>
                <path d="M2467 3710 c-25 -33 -33 -51 -25 -56 12 -8 48 31 74 79 25 47 -8 32
                -49 -23z"/>
                <path d="M2349 3561 c-31 -39 -37 -56 -20 -56 11 0 71 74 71 86 0 19 -21 7
                -51 -30z"/>
                <path d="M2217 3403 c-50 -62 -27 -73 25 -12 40 47 46 59 26 59 -7 0 -30 -21
                -51 -47z"/>
                <path d="M2083 3260 c-32 -37 -42 -60 -24 -60 9 0 91 85 91 95 0 18 -40 -3
                -67 -35z"/>
                <path d="M1947 3132 c-42 -33 -61 -62 -39 -62 12 0 102 71 102 81 0 20 -19 15
                -63 -19z"/>
                <path d="M1557 3139 c-54 -8 -62 -13 -53 -28 4 -6 18 -6 36 -1 36 10 34 10 65
                10 26 0 34 15 13 22 -7 2 -35 1 -61 -3z"/>
                <path d="M1706 3124 c-3 -8 0 -14 8 -14 7 0 31 -16 55 -36 46 -40 44 -52 -9
                -74 -17 -7 -27 -17 -24 -25 4 -11 14 -10 46 5 22 10 47 25 56 34 15 15 13 20
                -35 65 -55 52 -88 67 -97 45z"/>
                <path d="M1410 3030 c0 -43 23 -110 38 -110 19 0 21 15 6 38 -9 14 -16 44 -16
                69 1 31 -3 43 -13 43 -11 0 -15 -12 -15 -40z"/>
                <path d="M1833 2963 c3 -10 8 -40 12 -66 7 -52 32 -62 27 -11 -6 69 -13 94
                -28 94 -10 0 -14 -6 -11 -17z"/>
                <path d="M1619 2946 c-2 -2 -20 -6 -39 -8 -37 -5 -51 -33 -15 -32 51 1 105 17
                105 30 0 13 -40 20 -51 10z"/>
                <path d="M1850 2773 c-1 -4 -3 -34 -7 -65 -3 -38 -2 -58 5 -58 16 0 20 11 23
                69 2 36 -1 56 -9 59 -7 2 -12 0 -12 -5z"/>
                <path d="M1825 2568 c-9 -30 -25 -94 -25 -105 0 -7 6 -10 13 -7 12 4 37 84 37
                115 0 14 -20 11 -25 -3z"/>
                <path d="M1788 2378 c-8 -26 -3 -111 8 -115 6 -2 11 15 13 39 1 23 4 45 7 49
                6 10 -6 39 -16 39 -4 0 -10 -6 -12 -12z"/>
                <path d="M1782 2139 c2 -40 8 -64 16 -67 10 -3 12 11 10 59 -2 39 -8 64 -16
                67 -10 3 -12 -11 -10 -59z"/>
                <path d="M1797 1993 c-2 -5 -3 -17 -1 -28 10 -69 16 -85 30 -85 10 0 13 7 9
                23 -9 34 -13 60 -14 80 -1 17 -16 23 -24 10z"/>
                <path d="M1840 1803 c0 -18 27 -82 39 -97 26 -31 28 3 4 54 -21 43 -43 66 -43
                43z"/>
                <path d="M1930 1641 c0 -17 62 -91 78 -91 21 0 13 15 -33 60 -25 24 -45 38
                -45 31z"/>
                <path d="M2555 1517 c8 -64 8 -64 -64 -69 -27 -2 -46 -9 -49 -17 -4 -12 8 -13
                65 -8 l69 7 2 -28 c4 -49 9 -66 18 -69 11 -3 166 127 172 144 3 11 -25 28 -63
                39 -5 1 -35 12 -65 24 -99 39 -93 40 -85 -23z"/>
                <path d="M2072 1508 c5 -14 51 -42 86 -53 42 -12 23 19 -26 43 -54 25 -65 27
                -60 10z"/>
                <path d="M2252 1438 c5 -15 118 -25 118 -10 0 13 -16 18 -74 21 -36 2 -47 -1
                -44 -11z"/>
                </g>
                </svg>
          ...
          <div className="secondArrow hidden md:block absolute top-[20%] sm:top-[15%] md:top-[20%] lg:top-[25%] left-[50%] sm:left-[60%] md:left-[70%] transform sm:translate-y-[20px] md:translate-y-[50px] lg:translate-y-[80px]">
            ...
            {isDarkmode === 'light' ? (
             ...
             <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                width="479.000000pt" height="521.000000pt" viewBox="0 0 479.000000 521.000000"
                preserveAspectRatio="xMidYMid meet" className="w-[150px] sm:w-[180px] md:w-[300px] lg:w-[260px]">

                <g transform="translate(0.000000,521.000000) scale(0.100000,-0.100000)"
                fill="#ffffff " stroke="none">
                <path d="M602 4362 c-47 -4 -64 -24 -40 -48 19 -19 140 -29 169 -14 19 10 19
                14 6 33 -16 24 -63 34 -135 29z"/>
                <path d="M817 4332 c-2 -4 -3 -18 -3 -32 1 -18 7 -25 21 -26 11 -1 31 -5 45
                -10 14 -4 28 -9 33 -10 4 -1 8 -2 10 -3 13 -11 60 -7 72 6 20 19 15 35 -16 50
                -21 10 -46 15 -136 28 -13 2 -24 0 -26 -3z"/>
                <path d="M1075 4235 c3 -31 -4 -25 78 -64 70 -34 97 -35 97 -3 0 20 -29 52
                -48 52 -6 0 -27 9 -47 20 -20 11 -46 20 -59 20 -20 0 -24 -5 -21 -25z"/>
                <path d="M1315 4124 c-8 -9 -15 -19 -15 -23 0 -4 27 -31 61 -59 61 -52 95 -64
                105 -38 8 21 -49 89 -96 114 -35 19 -41 19 -55 6z"/>
                <path d="M1507 3953 c-14 -13 -6 -42 20 -73 15 -18 34 -46 42 -63 19 -36 31
                -42 54 -24 16 11 17 15 3 47 -34 83 -94 139 -119 113z"/>
                <path d="M1649 3724 c-10 -13 -10 -21 0 -47 7 -18 21 -54 31 -81 18 -50 41
                -66 66 -45 11 9 8 55 -6 74 -4 6 -10 22 -13 36 -7 28 -43 79 -57 79 -4 0 -13
                -7 -21 -16z"/>
                <path d="M1730 3450 c0 -35 19 -129 31 -152 10 -18 45 -14 52 6 5 13 -15 124
                -28 159 -4 9 -18 17 -31 17 -20 0 -24 -5 -24 -30z"/>
                <path d="M1765 3207 c-2 -7 -6 -36 -10 -66 -3 -29 -8 -57 -10 -61 -3 -5 -1
                -20 5 -34 10 -28 50 -37 50 -11 0 24 1 29 9 40 7 9 11 39 15 110 1 25 -3 30
                -27 32 -15 1 -30 -3 -32 -10z"/>
                <path d="M1751 2951 c-10 -7 -12 -26 -7 -87 7 -83 18 -106 44 -97 25 9 31 23
                26 57 -3 17 -6 51 -8 75 -4 52 -24 71 -55 52z"/>
                <path d="M1787 2703 c-19 -19 19 -148 50 -171 45 -33 54 21 17 103 -29 68 -49
                87 -67 68z"/>
                <path d="M1897 2474 c-16 -17 -4 -43 49 -102 45 -50 59 -60 70 -51 22 18 18
                27 -43 93 -61 66 -66 70 -76 60z"/>
                <path d="M2069 2299 c-12 -7 -12 -12 1 -36 17 -30 134 -95 157 -86 25 10 14
                47 -20 66 -17 11 -34 19 -37 19 -3 0 -12 6 -20 13 -24 22 -65 34 -81 24z"/>
                <path d="M2307 2183 c-4 -3 -7 -17 -7 -29 0 -19 8 -24 58 -35 89 -19 120 -19
                125 2 6 24 -7 33 -75 53 -60 17 -91 20 -101 9z"/>
                <path d="M2563 2163 c-14 -5 -18 -63 -5 -63 4 0 41 -2 82 -4 43 -3 80 0 87 6
                17 14 17 48 1 49 -80 5 -135 10 -143 13 -5 2 -16 1 -22 -1z"/>
                <path d="M2819 2133 c-19 -23 2 -47 47 -55 21 -3 52 -9 67 -12 39 -9 67 1 67
                24 0 24 -24 37 -81 45 -24 4 -54 8 -66 10 -12 2 -28 -4 -34 -12z"/>
                <path d="M3067 2070 c-6 -24 8 -36 53 -45 19 -4 49 -13 65 -20 37 -15 78 -3
                73 22 -4 21 -101 62 -149 63 -28 0 -38 -5 -42 -20z"/>
                <path d="M3331 1986 c-19 -23 -9 -38 45 -65 27 -14 56 -31 65 -38 19 -16 45
                -9 53 14 7 16 -19 53 -37 53 -5 0 -21 9 -36 19 -40 29 -75 35 -90 17z"/>
                <path d="M3553 1853 c-25 -9 -12 -45 39 -108 28 -36 54 -65 58 -65 3 0 15 6
                25 14 18 13 17 16 -22 68 -53 68 -85 97 -100 91z"/>
                <path d="M3694 1583 c3 -21 12 -63 19 -93 11 -45 17 -55 35 -56 37 -2 42 17
                26 81 -8 33 -18 70 -21 83 -4 16 -13 22 -35 22 -28 0 -29 -1 -24 -37z"/>
                <path d="M3731 1339 c-5 -15 -7 -30 -4 -33 3 -3 0 -12 -7 -21 -9 -11 -27 -14
